...
<li>Quande it es fat (it ne va esser long), returna vers ti tabul por inserter tu splendid nov formul.</li></ul>',
    ...
    'Can add, edit and delete forms and answers' => 'Posse addir, modificar et deleter formuls e responses',
    ...
    'Received on {{date}}' => 'Recivet li {{date}}',
    ...
    'Click on an answer to preview it.' => 'Clica sur li response por previsualisar it.',
    ...
    'Virtual name:' => 'Virtual nomine:',

    #: config/controller/admin/form.config.php:69
    'Captcha protected' => 'Protectet per un captcha',

    #: config/controller/admin/form.config.php:77
    'Submit button’s label:' => 'Etiquette del buton de expedition:',
...
Seniora',
    ...
    'Select a form:' => 'Selecter un formul:',

    #: config/controller/admin/enhancer.config.php:48
    'Label position:' => 'Position de li etiquette:',

    #: config/controller/admin/enhancer.config.php:52
    'Top aligned' => 'Supra li intrada',

    #: config/controller/admin/enhancer.config.php:53
    'Left aligned' => 'Levul di intrada, alineat a levul',

    #: config/controller/admin/enhancer.config.php:54
    'Right aligned' => 'Levul del intrada, alineat a dextri',

    #: config/controller/admin/enhancer.config.php:55
    'In the field (placeholder), for text fields only' => 'In li intrada (Intradas de textu solmen)',

    #: config/controller/admin/enhancer.config.php:61
    'Once the user submitted the form:' => 'Pos li usator submisset li formul:',

    #: config/controller/admin/enhancer.config.php:66
    'Display a message' => 'Exhibir un missage',

    #: config/controller/admin/enhancer.config.php:67
    'Redirect to a page' => 'Redirecter vers un pagine',
    ...
    'All good! Your new form has been added.' => 'Excellent! Tu nov formul ha esset addit',

    #: config/common/form.config.php:58
    'The form has been deleted.' => 'Li formul ha esset deletet',

    #. General errors
    #: config/common/form.config.php:61
    'This form doesn’t exist any more. It has been deleted.' => 'Ti formul ne plu existe. It ha esset deletet.',

    #: config/common/form.config.php:62
    'We cannot find this form.' => 'Noi ne posse truvar ti formul',
    ...
    'The answer has been deleted.' => 'Li response ha esset deletet',

    #. General errors
    #: config/common/answer.config.php:44
    'This answer doesn’t exist any more. It has been deleted.' => 'Ti response ne plu existe. It ha esset deletet.',

    #: config/common/answer.config.php:45
    'We cannot find this answer.' => 'Ne posse truvar ti response.',
