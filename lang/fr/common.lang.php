...
return array(
    ...
    'Pick a form:' => 'Choisir un formulaire:',
    ...
    'Pick another form' => 'Choisir un autre formulaire',

    #: config/controller/admin/enhancer.config.php:52
    'Un-select this form' => 'Dé-sélectionner ce formulaire',
...
M.',
    ...
    'There is no answer yet.' => 'Il n\'y a pas de réponse pour le moment.',
    'Unable to find the form.' => 'Impossible de trouver le formulaire.',
    'This form has no answer.' => 'Ce formulaire n\'a pas de réponse.',
    'The answers have been deleted.' => 'Les réponses ont été supprimé.',
    'This form has <strong>1 answer</strong>.' => 'Ce formulaire a <strong>1 réponse</strong>.',
    'This form has <strong>{{count}} answers</strong>.' => 'Ce formulaire a <strong>{{count}} réponses</strong>.',
    'Yes, I want to delete the {{count}} answer(s).' => 'Oui, je veux supprimer ces {{count}} réponse(s).',
    'Delete these answers' => 'Supprimer ces réponses',
