...
return array(
    #: classes/controller/front.ctrl.php:66
    ...
    #: classes/controller/front.ctrl.php:126
    ...
    #: classes/controller/admin/form.ctrl.php:198
    #: classes/controller/admin/form.ctrl.php:213
    ...
    #: views/foundation.view.php:240
    'Previous page' => 'Page précédente',

    #: views/foundation.view.php:244
    'Next page' => 'Page suivante',

    #: views/foundation.view.php:251
    ...
    #: config/controller/admin/form.config.php:78
    ...
    #: config/controller/admin/form.config.php:119
    'Email address:' => 'Email :',
    ...
    #: config/controller/admin/form.config.php:151
    ...
    #: config/controller/admin/form.config.php:177
    ...
    #: config/controller/admin/form.config.php:211
    ...
    #: config/controller/admin/form.config.php:224
    ...
    #: config/controller/admin/form.config.php:237
    ...
    #: config/controller/admin/form.config.php:276
    'Second address line:' => 'Adresse (ligne 2) :',

    #: config/controller/admin/form.config.php:280
    'Postal code:' => 'Code postal :',

    #: config/controller/admin/form.config.php:284
    'City:' => 'Ville',
    ...
    #: config/controller/admin/form.config.php:304
    #: config/controller/admin/form.config.php:309
    #: config/controller/admin/form.config.php:409
    'Separator' => 'Séparateur',

    #: config/controller/admin/form.config.php:317
    #: config/controller/admin/form.config.php:408
    'Hidden' => 'Caché',

    #: config/controller/admin/form.config.php:324
    ...
    #: config/controller/admin/form.config.php:331
    #: config/controller/admin/form.config.php:410
    'Variable' => 'Variable',

    #: config/controller/admin/form.config.php:351
    'Properties' => 'Propriétés',

    #: config/controller/admin/form.config.php:364
    'Further options' => 'Plus d’options',

    #: config/controller/admin/form.config.php:375
    ...
    #: config/controller/admin/form.config.php:440
    'Style:' => 'Style&nbsp;:',

    #: config/controller/admin/form.config.php:444
    'Standard' => 'Standard',

    #: config/controller/admin/form.config.php:445
    'Heading 1' => 'Titre 1',
    ...
    #: config/controller/admin/form.config.php:463
