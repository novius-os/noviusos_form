...
// 147 out of 154 messages are translated (95%).
// 560 out of 591 words are translated (95%).
...
return array(
    ...
    'Thank you. Your answer has been sent.' => '',
    ...
    'I’m the submit button, click to edit me' => '',

    #: config/controller/admin/form.config.php:84
    'For every new answer, an email notification is sent to:' => '',
...
Second choice' => '',
    ...
    'I’m the label of a file input, click to edit me:' => '',
...
Mr' => '',
    ...
    'I’m the label for internal use only as I won’t be shown to users:' => '',
    ...
    'I’m the label, click to edit me:' => '',

    #: config/controller/admin/form.config.php:424
    'I’m a message, click to edit me.' => '',
    ...
    'Click on an answer to preview it.' => '',
    ...
    'All good! Your new form has been added.' => '',
    ...
    'This form doesn’t exist any more. It has been deleted.' => '',

    #: config/common/form.config.php:62
    'We cannot find this form.' => '',

    #. Deletion popup
    #: config/common/form.config.php:65
    'Deleting the form ‘{{title}}’' => '',
    ...
    'We cannot delete this form as the number of answers you’ve entered is wrong. Please amend it.' => '',
    ...
    'Export the answers (spreadsheet)' => '',
    ...
    'This answer doesn’t exist any more. It has been deleted.' => '',

    #: config/common/answer.config.php:45
    'We cannot find this answer.' => '',

    #. Deletion popup
    #: config/common/answer.config.php:48
    'Deleting the answer ‘{{title}}’' => '',
    ...
    'Help us prevent spam: How much is {{number_1}} plus {{number_2}}?' => '',

    #: views/captcha.view.php:35
    'You have not passed the spam test. Please try again.' => '',

    #: views/admin/form/warning_answers_collected.view.php:26
    'Modifying the form may alter the collected data.' => '',

    #: views/admin/form/warning_answers_collected.view.php:29
    'You’re right, take me to the answers' => '',
    ...
    'Answers to this form have already been received' => '',
    ...
    'Yes, I want to delete this form and the {{count}} answers received.' => '',

    #: views/admin/form/warning_not_published.view.php:18
    'Not published' => '',

    #: views/admin/form/warning_not_published.view.php:19
    'To publish this form, add it to a page, a blog post or any other text editor.' => '',

    #: views/admin/form/warning_not_published.view.php:22
    '<p>Most Novius OS text editors (also called WYSIWYG editors) feature this button {{preview}} in the toolbar.</p><p>Click it to access the list of applications you can enhance your text with.</p>' => '',
    ...
    'Help us prevent spam: How much is 3 plus 8?' => '',
