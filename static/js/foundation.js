(function(window, document, undefined) {
    ...
    add_script('//ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js', function() {
        add_script('static/apps/noviusos_form/vendor/webshims-1.9.4/minified/extras/modernizr-custom.js', function() {
            add_script('static/apps/noviusos_form/vendor/webshims-1.9.4/minified/polyfiller.js', function() {
                jQuery(function() {
                    doPagination(jQuery);
                });
            });
